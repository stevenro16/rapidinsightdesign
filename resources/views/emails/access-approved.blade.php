        ...
        <tr><td align="center">
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:12px; overflow:hidden; border:1px solid #d9dee8;">
                ...
                <tr><td style="padding:28px 32px 8px;">
                    <h1 style="margin:0 0 14px; font-size:22px; color:#0D1117;">You're approved! 🎉</h1>
                    <p style="margin:0 0 16px; font-size:15px; line-height:1.6;">Hi {{ $customer->name }},</p>
                    <p style="margin:0 0 16px; font-size:15px; line-height:1.6;">
                        Good news — your request to access <strong>“{{ $item->title }}”</strong> has been approved.
                        You can now launch the live demo and view the login details from your ShowRoom.
                    </p>
                </td></tr>
