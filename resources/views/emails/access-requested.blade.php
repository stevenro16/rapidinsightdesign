        ...
        <tr><td align="center">
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:12px; overflow:hidden; border:1px solid #d9dee8;">
                ...
                <tr><td style="padding:32px;">
                    <h1 style="margin:0 0 10px; font-size:21px; color:#0D1117;">Demo Access Requested</h1>
                    <p style="margin:0 0 20px; font-size:15px; line-height:1.6;">
                        <strong>{{ $customer->name }}</strong> ({{ $customer->email }}) has requested access to the demo
                    ...
                    <p style="margin:18px 0 0; font-size:13px; color:#6e7781;">Approve it from the Showcase &rarr; Customer Access tab.</p>
                </td></tr>
